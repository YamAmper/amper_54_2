...
import 'package:facebook/page/notifcation.dart';
    ...
    return  Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: CircleAvatar(backgroundImage: AssetImage("assets/profile/prof2.jpg"),), label:"Profile"),
        ]
      ),
    );
  }
